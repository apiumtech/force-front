define([
    ...
    TopMenuCFMModel.prototype.logout = function () {
        ...
        /*this.authAjaxService.rawAjaxRequest(params).then(
            function (data) {
                self.storageService.clear(true);
                deferred.resolve();
            }
        );*/
        setTimeout(function () {
    ...
    TopMenuCFMModel.prototype.getUserDataInfo = function () {
		...
		this.authAjaxService.rawAjaxRequest(params).then(
			function (data) {
                ...
                self.storageService.store(self.configuration.implementationCodeKey, userData.userData.idImplementation);
