...
], function(AccountListPresenter, AccountListView, AccountListModel) {
    'use strict';

    describe('AccountListPresenter Test', function() {
        var sut, model, view;
        beforeEach(function(){
            model = mock(AccountListModel);
            view = mock(AccountListView);
            sut = new AccountListPresenter(model);
            view.event = {};
        });
