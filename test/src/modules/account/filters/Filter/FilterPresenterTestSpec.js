...
define([
    ...
    describe("FilterPresenter", function () {
        ...
        [
            ...
            {
                viewEvent: 'onShowAvailableFilters',
                modelMethod: 'getAvailableFilters',
                onSuccess: 'showAvailableFilters',
                onError: 'showError'
            },
            ...
            {
                viewEvent: 'onShowAvailableOwners',
                modelMethod: 'getAvailableOwners',
                onSuccess: 'setAvailableOwners',
                onError: 'showError'
            }
        ].forEach(function (e) {
