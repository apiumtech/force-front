...
], function (ConversionDiagramActivityWidgetPresenter) {
    'use strict';
    describe("ConversionDiagramActivityWidgetPresenter", function () {
        var sut;

        beforeEach(function () {
            sut = ConversionDiagramActivityWidgetPresenter.newInstance();
        });
