...
describe("AccountEditPresenter", function () {
    var AccountEditPresenter = app.getPresenter('presenters/accountDetails/AccountEditPresenter');
    var sut, view, model;

    beforeEach(function () {
        sut = AccountEditPresenter.newInstance().getOrElse(throwInstantiateException(AccountEditPresenter));
        view = {event: {}};
        model = {};
    });
