...
define([
    ...
    describe("EventBus", function () {
        ...
        it("should respond to events in a subscribed channel", function () {
            var S = EventBus.subscribe({
                channel: "A", topic: "B", callback: function (data) {
        ...
        it("should not catch events on different subscriptions", function () {
            var S = EventBus.subscribe({
                channel: "A", topic: "A", callback: function (data) {
                    expect(true).toEqual(true);
                }
            });

            var NotS = EventBus.subscribe({
                channel: "B", topic: "B", callback: function (data) {
